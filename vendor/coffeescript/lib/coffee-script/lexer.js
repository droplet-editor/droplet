...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.tokenize = function(code, opts) {
      var consumed, i, tag, _ref2, _ref3;
      if (opts == null) {
        opts = {};
      }
      this.literate = opts.literate;
      this.preserveComments = (_ref2 = opts.preserveComments) != null ? _ref2 : false;
      this.indent = 0;
      this.baseIndent = 0;
      this.indebt = 0;
      this.outdebt = 0;
      ...
      while (this.chunk = code.slice(i)) {
        ...
        _ref3 = this.getLineAndColumnFromChunk(consumed), this.chunkLine = _ref3[0], this.chunkColumn = _ref3[1];
        i += consumed;
      }
