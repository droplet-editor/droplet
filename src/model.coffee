...
exports.ButtonContainer = class ButtonContainer extends Container
  constructor: (@parseContext, @buttons = {}, @data = {}) ->
...
# LockedSocket
# ============
exports.LockedSocket = class LockedSocket extends Container
  constructor: (@parseContext, @dropdown, @data = {}) ->
    @start = new LockedSocketStartToken this
    @end = new LockedSocketEndToken this
  ...
  _cloneEmpty: -> new LockedSocket @parseContext, @dropdown, @data

exports.LockedSocketStartToken = class LockedSocketStartToken extends StartToken
  constructor: -> super; @type = 'lockedSocketStart'

exports.LockedSocketEndToken = class LockedSocketEndToken extends EndToken
  constructor: -> super; @type = 'lockedSocketStart'
...
exports.Block = class Block extends Container
  constructor: (@color = 'blank', @shape = helper.ANY_DROP, @parseContext = '__comment__', @nodeContext = COMMENT_CONTEXT, @buttons = {}, @data = {}) ->
  ...
  _cloneEmpty: ->
    clone = new Block @color, @shape, @parseContext, @nodeContext, @buttons, @data
...
exports.Socket = class Socket extends Container
  constructor: (
      ...
      # Is this a temporary socket generated by a lockedSocket?
      @fromLocked = false
      ) ->
  ...
  _cloneEmpty: -> new Socket @emptyString, @handwritten, @dropdown, @parseContext, @fromLocked
