...
# ## ElementWrapper ###
exports.ElementWrapper = class ElementWrapper
  constructor: (@draw, @element) ->
    if @element?
      @element.style.display = 'none'
    @active = false
    @parent = @element?.parentElement ? @draw.ctx
...
exports.Group = class Group extends ElementWrapper
...
exports.Path = class Path extends ElementWrapper
  constructor: (@draw, @_points = [], @bevel = false, @style) ->
